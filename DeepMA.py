...
if __name__ == '__main__':
    ...
    datafile1 =u'C:/Users/admin/Desktop/DeepMA/Spectrumdata_mixture.npy'
    Xtest = np.load(datafile1) 

    datafile2 =u'C:/Users/admin/Desktop/DeepMA/ALL_label_mixture.npy'
    ...
    for j in range(Xtest.shape[0]):
        ...
        for h in range(n):
            if (ypre[h,0]>=0.5):
                print(names[h])                   
        print('The prediction finished, the precision %.1f%%' % accuracy(y_real,ypre))
